...
",
    ...
    public void WriteCSharpExpressionAttributeValue_RendersCorrectly()
    {
        ...
        var node = (CSharpExpressionAttributeValueIntermediateNode)documentNode.FindDescendantNodes<HtmlAttributeIntermediateNode>().Single().Children[1];
...
",
    ...
    public void WriteCSharpCodeAttributeValue_RendersCorrectly()
    {
        ...
        var processor = CreateCodeDocumentProcessor(codeDocument);
        var documentNode = processor.GetDocumentNode();
        var node = (CSharpCodeAttributeValueIntermediateNode)documentNode.FindDescendantNodes<HtmlAttributeIntermediateNode>().Single().Children[1];
